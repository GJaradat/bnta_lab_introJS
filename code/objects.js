 ...
 */
tortoise.age += 1;
console.log("Tortoise's age is now " + tortoise.age);
...
console.log("This is my new parrot: ");
console.log(parrot);
...
console.log("Ella's favourite food is " + tortoise.favouriteFood);
// console.log(tortoise);
...
delete cat.breed;
if(!cat.breed) {
  console.log("The cat's breed has been removed");
}
// console.log(cat);
